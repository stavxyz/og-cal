...
describe("applyStickyClasses", () => {
  it("adds already-sticky class to enabled containers", () => {
    ...
    applyStickyClasses(
      { header: true, viewSelector: true, tagFilter: true },
      h,
      s,
      t,
    );
  ...
  it("does not add already-sticky to disabled containers", () => {
    ...
    const t = document.createElement("div");
    applyStickyClasses(
      { header: false, viewSelector: true, tagFilter: false },
      h,
      s,
      t,
    );
  ...
  it("removes already-sticky when toggled off", () => {
    ...
    const t = document.createElement("div");
    applyStickyClasses(
      { header: false, viewSelector: false, tagFilter: false },
      h,
      s,
      t,
    );
...
describe("updateStickyOffsets", () => {
  it("sets top:0px on the first sticky container", () => {
    ...
    const t = document.createElement("div");
    updateStickyOffsets(
      { header: true, viewSelector: false, tagFilter: false },
      h,
      s,
      t,
    );
