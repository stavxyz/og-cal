...
export function applyStickyClasses(
  stickyConfig,
  headerContainer,
  selectorContainer,
  tagFilterContainer,
...
export function updateStickyOffsets(
  ...
  if (
    stickyConfig.header &&
    headerContainer.classList.contains("already-sticky")
  ) {
  ...
  if (
    stickyConfig.viewSelector &&
    selectorContainer.classList.contains("already-sticky")
  ) {
  ...
  if (
    stickyConfig.tagFilter &&
    tagFilterContainer.classList.contains("already-sticky")
  ) {
